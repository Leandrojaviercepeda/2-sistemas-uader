...
def telefono(caracteristica, numero):
    if len(caracteristica) == 2 and len(numero) == 8:
        return True

    elif len(caracteristica) == 3 and len(numero) == 7:
        return True

    elif len(caracteristica) == 4 and len(numero) == 6:
        return True

    return False


def upperLowerWord(palabra):
    """
    Pone la primer letra de cada palabra en mayuscula, el resto en minuscula.
    """
    oracion = palabra.split(" ")
    oracion = [p for p in oracion if p != '']
    oracion = [p.lower() for p in oracion]
    salida = ""
...
def caracteresEspeciales(string):
    """
    Verifica si hay o no caracteres especiales como: "/", "`", '#', "%", ">",
    "<", "!", ".", "[", "]", "*", "$", ";", ":", "?", "^", "{", "}", "+", "-","\ "
    """
    caracteres = ["/", "`", '#', "%", ">", "<", "!", ".", "[", "]", "*", "$", ";", ":", "?", "^", "{", "}", "+", "-",
                  "\ "]
...
def caracteristica(caracteristica):
    """
    Verifica que la caracteristica del telefono este dentro de las caracteristicas validas existentes.

    @return boolCaracteristica: devuelve True si es valida, False en caso contrario.
    """
    caracteristicas = ["11", "220", "2202", "221", "2221", "2223", "2224", "2225", "2226", "2227",
                       ...
                       "2331", "2325", "2326", "2333", "2334", "2335", "2336", "2337", "2338", "2342",
                       "2343", "2344", "2345", "2346", "2352", "2353", "2354", "2355", "2356", "2357",
                       "2358", "236", "237", "2392", "2394", "2393", "2395", "2396", "2473", "2474",
                       "2475", "2477", "2478", "249", "260", "261", "2622", "2624", "2625", "2626",
                       "263", "264", "2646", "2647", "2648", "2651", "2655", "2656", "2657", "2658",
                       "266", "280", "2901", "2902", "2903", "2921", "291", "2920", "2922", "2923",
                       "2924", "2925", "2927", "2926", "2928", "2929", "2931", "2932", "2933", "2934",
